        ...
        <el-submenu index="2">
          ...
          <el-menu-item index="2-2">病例查询</el-menu-item>
            ...
            <el-submenu index="3">
              ...
              <el-menu-item index="3-1">
                邮件处理
                <span class="mark">
                <el-badge :value="32" :max="30" type="warning" style="margin-left:10px"/>
                </span>
              </el-menu-item>
              <el-menu-item index="3-2">
                档案审阅
                <span class="mark">
                  <el-badge :value="12" :max="50" style="margin-left:10px"/>
                </span>
              </el-menu-item>
          ...
          <el-submenu index="5" class="right">
            <template slot="title"><el-avatar src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png"></el-avatar></template>
              ...
              <router-link to="/"><el-menu-item index="5-2">切换账号</el-menu-item></router-link>
              <router-link to="/"><el-menu-item index="5-3">退出</el-menu-item></router-link>
          </el-submenu>
      </el-menu>
    </el-header>
</template>
